...
- Changes to shared publishing or sync logic increment every plugin whose distributed behavior changes. When the affected set is unclear, increment both plugins.
