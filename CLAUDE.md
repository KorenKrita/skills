...
plugins/plus/skills/<skill>/SKILL.md      工程、思考、工具、写作与单一 PUA Skill（9）
...
- 当前唯一的本地自有 Skill 是 `base/improve-codebase-architecture`。
...
- `base` 固定 7 个 Skill、`plus` 固定 9 个；Skill 正文不得调用仓库不再发布的 Skill。
