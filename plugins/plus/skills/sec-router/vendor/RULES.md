...
4. ACT:  Open PRIMARY MOD.md and execute ACTION REQUIRED. Tools only from tool-index.md; missing → platform-native bootstrap.
...
5. Open PRIMARY MOD.md ACTION REQUIRED
...
4. ACT: Open PRIMARY MOD.md; timeline/workitems + Evidence→Finding→Path (ops/*)
```
