...
本项目不绑定某一个客户端。它的核心资产是 `RULES.md`、`skills/MOD.md`、`skills/routing.md`、工具索引、子 Skill 和 MCP / 脚本入口。
...
2. 执行其中的第 0 节；
3. 读取 `RULES.md`；
4. 加载 `skills/MOD.md` 和 `skills/routing.md`；
5. 先路由，再执行。
...
- 有明确入口：`RULES.md`、`MOD.md`、`routing.md`；
