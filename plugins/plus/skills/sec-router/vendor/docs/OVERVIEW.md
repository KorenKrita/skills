...
The repository is not tied to one client. Its core assets are `RULES.md`, `skills/MOD.md`, `skills/routing.md`, tool indexes, sub-skills, and MCP/script entry points.
...
2. execute section 0;
3. read `RULES.md`;
4. load `skills/MOD.md` and `skills/routing.md`;
...
- clear entries: `RULES.md`, `MOD.md`, `routing.md`;
