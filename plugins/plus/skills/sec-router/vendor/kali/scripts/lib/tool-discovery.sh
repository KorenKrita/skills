...
declare -A SCRIPT_REFS=(
    ...
    ["playwright"]="browser-automation/MOD.md"
    ["nmap"]="pentest-tools/MOD.md"
    ["proxycat"]="pentest-tools/MOD.md"
    ["metasploitmcp"]="pentest-tools/MOD.md"
    ["mcp-kali-server"]="pentest-tools/MOD.md"
    ["hexstrike-ai"]="pentest-tools/MOD.md"
    ["adaptixc2"]="pentest-tools/MOD.md"
    ["sstimap"]="pentest-tools/MOD.md"
    ["xsstrike"]="pentest-tools/MOD.md"
    ["wpprobe"]="pentest-tools/MOD.md"
    ["coercer"]="pentest-tools/MOD.md"
    ["pentestswarm"]="pentest-tools/MOD.md"
    ["evil-winrm-py"]="pentest-tools/MOD.md"
    ["gef"]="reverse-engineering/MOD.md"
    ["bkcrack"]="reverse-engineering/crypto-decode-tools.md,../CTF-Sandbox-Orchestrator/competition-zip-archive/MOD.md"
    ["netexec"]="pentest-tools/MOD.md"
    ["responder"]="pentest-tools/MOD.md"
)
