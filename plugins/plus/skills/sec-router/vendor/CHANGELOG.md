...
- **Skill navigation index** — `skills/INDEX.md` auto-generated from MOD.md frontmatter by `extract-summaries.ps1` (`-Check` mode for CI drift detection).
...
- **frontmatter completion** — `dsl-vm-reverse/MOD.md` gained name/description frontmatter (was the only module missing it).
