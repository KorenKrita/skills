...
if [[ "$ready" == true ]]; then
  timeline_next="open PRIMARY MOD.md and ACT within scope"
...
if [[ "$ready" == true ]]; then
  echo "NEXT: open PRIMARY MOD.md and ACT within scope"
else
  echo "NEXT: fill scope.md auth + in_scope; then open PRIMARY MOD.md"
