...
.DESCRIPTION
  P1-4 guard: RULES.md / RULES_zh.md / skills/MOD.md fact tables must not
...
$skillMd = Get-Content (Join-Path $Root 'skills\MOD.md') -Raw -Encoding UTF8
...
Check 'MOD.md capability list' (Test-ListHasAll $skList $capNames) "expected $($capNames.Count) capabilities"
