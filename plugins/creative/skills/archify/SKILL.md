...
Every bundled scenario recipe is backed by a checked-in, validated JSON example in `examples/`. Use those examples as structural references rather than copying their domain facts.
